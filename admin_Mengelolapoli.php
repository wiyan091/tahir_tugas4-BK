...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update_poli_modal'])) {
  ...
  if ($stmt->execute()) {
    // Update successful
    header("Location: admin_Menumengelolapoli.php");
    exit();
  } else {
            ...
            <div class="card">
              <div class="card-body">
                ...
                <form method='post' action=''>
                    ...
                    <button type='button' name='update_poli' class='btn btn-primary btn-sm update-btn' data-toggle='modal' data-target='#updateModal' 
                    data-id='" . $poliRow['id'] . "' 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="admin_Menumengelolapoli.php">

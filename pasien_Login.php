...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            header("Location: pasien_Menudaftarpoli.php");
        } else {
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=pasien_Login">
                        <?php
                        if (isset($error)) {
                    ...
                    <div class="text-center">
                        <br>
                        <a href="index.php?page=pasien_Register" class="btn btn-dark">Daftar</a>
                    </div>
                </div>
            </div>
        </div>
